        ...
        <div class="container-fluid">
            ...
            <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="header-title">Start Writing your Terms Conditions</h4>
                                   
                                    @include('alert.messages')
                                    <div class="row">
                                        <div class="col-12">
                                            <div>
                                                <form action="{{route('admin.termsConditions.store')}}" enctype="multipart/form-data" method="POST">
                                                    @csrf
                                                    {{method_field('PUT')}}
                                                    <div class="form-group row">
                                                        <label class="col-md-2 col-form-label" for="example-textarea">TermsConditions Description</label>
                                                        <div class="col-md-10">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-warning" role="alert">
                                   <h1>You have already Inserted Terms & Conditions Now you can only Edit them !</h1> 
                                  </div>
                            </div>
                        </div>
                        @endif
