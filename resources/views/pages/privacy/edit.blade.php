            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Privacy Policy update table</h4>
                    </div>
                </div>
            </div>     
            <!-- end page title --> 
                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div>
                                                <form action="{{route('admin.privacy.update',$PrivacyPolicy->id)}}" enctype="multipart/form-data" method="POST">
                                                    @csrf
                                                   
                                                    <div class="form-group row">
                                                        <label class="col-md-2 col-form-label" for="example-textarea">About Us Description</label>
                                                        <div class="col-md-10">
                                                            <textarea id="my-editor" name="details" class="form-control">{{ $PrivacyPolicy->details }}</textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <img src="{{url($PrivacyPolicy->image)}}" class="img-thumbnail" style="height: 100px;width:auto;">
                                                    </div>
