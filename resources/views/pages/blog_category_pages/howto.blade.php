                ...
                <div class="col-lg-8">
                    <div class="categorie-title">
                        <small>
                            ...
                            <span class="arrow_carrot-right"></span> How To
                        </small>
                    ...
                    <div class="card-columns">
                        ...
                        <div class="card">
                            ...
                            <div class="post-card-image">
                                <a href="{{route('allpost' , [$howto->id,$howto->category])}}">
                                    <img src="{{url($howto->image)}}" alt="">
                                </a>
                            </div>
                            <div class="post-card-content">
                                <a href="{{route('allpost' , [$howto->id,$howto->category])}}" class="categorie">{{$howto->category}}</a>  
                                ...
                                <div class="post-card-info">
                                    <ul class="list-inline">
                                        ...
                                        <li><?php
                                            ...
                                            echo date("d.m.Y", strtotime($howto->created_at));
