                ...
                <div class="col-lg-8">
                    <div class="categorie-title">
                        <small>
                            ...
                            <span class="arrow_carrot-right"></span> Travel
                        </small>
                    ...
                    <div class="card-columns">
                        ...
                        <div class="card">
                            ...
                            <div class="post-card-image">
                                <a href="{{route('allpost' , [$travel->id,$travel->category])}}">
                                    <img src="{{url($travel->image)}}" alt="">
                                </a>
                            </div>
                            <div class="post-card-content">
                                <a href="{{route('allpost' , [$travel->id,$travel->category])}}" class="categorie">{{$travel->category}}</a>  
                                <h5><a href="{{route('allpost' , [$travel->id,$travel->category])}}">{{$travel->title}}</a> </h5>
                                <p>{{$travel->highlightedText}}
                                </p>
