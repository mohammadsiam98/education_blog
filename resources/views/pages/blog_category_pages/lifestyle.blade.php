                ...
                <div class="col-lg-8">
                    <div class="categorie-title">
                        <small>
                            ...
                            <span class="arrow_carrot-right"></span> Lifestyle
                        </small>
                        <h3>Category : <span>Lifestyle</span> </h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-columns">
                        ...
                        <div class="card">
                            ...
                            <div class="post-card-image">
                                <a href="{{route('allpost' , [$lifestyle->id,$lifestyle->category])}}">
                                    <img src="{{url($lifestyle->image)}}" alt="">
                                </a>
                            </div>
                            <div class="post-card-content">
                                <a href="{{route('allpost' , [$lifestyle->id,$lifestyle->category])}}" class="categorie">{{$lifestyle->category}}</a>  
                      ...
                      <div class="pagination mt-30">
                        @if ($blogs_lifestyle->lastPage() >1)
                        <ul class="list-inline">
                            <li class="{{$blogs_lifestyle->currentPage() == 1 ? 'disabled' : ''}}"><a class="" href="{{$blogs_lifestyle->url(1)}}"><i class="arrow_carrot-2left"></i></a>
                                @for($i=1; $i<=$blogs_lifestyle->lastPage();$i++)
                                <li class="siam {{$blogs_lifestyle->currentPage() == $i ? 'current' : ''}}">
                                  <a class='page-numbers' href='{{$blogs_lifestyle->url($i)}}'>{{$i}}</a></li>
                                @endfor
                                <li class="{{$blogs_lifestyle->currentPage() == $blogs_lifestyle->lastPage() ? 'disabled' : '' }}"><a class="disabled" href="{{$blogs_lifestyle->url($blogs_lifestyle->currentPage() +1 )}}"><i class="arrow_carrot-2right"></i></a></li>
