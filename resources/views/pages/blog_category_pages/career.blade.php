            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="categorie-title">
                        ...
                        <h3>Category : <span>Career</span> </h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 mt--10 ">
                    ...
                    <div class="card-columns">
                        <!--Post-Start-->
                        @foreach($blogs_career as $key=>$career)

                        <div class="card">
                            <div class="post-card">
                            <div class="post-card-image">
                                <a href="{{route('allpost' , [$career->id,$career->category])}}">
                                    <img src="{{url($career->image)}}" alt="">
                                </a>
                            </div>
                            <div class="post-card-content">
                                <a href="{{route('allpost' , [$career->id,$career->category])}}" class="categorie">{{$career->category}}</a>  
                                <h5><a href="{{route('allpost' , [$career->id,$career->category])}}">{{$career->title}}</a> </h5>
                                <p>{{$career->highlightedText}}
                                </p>
                                <div class="post-card-info">
                                    <ul class="list-inline">
                                        <li><a href="#"><img src="{{$user_information[$key]->image}}" alt=""></a></li>
                                        <li>
                                            <a href="author.html">{{$career->name}}</a>
                                        </li>
                                        <li class="dot"></li>
                                        <li><?php                                                
                                            echo date("d.m.Y", strtotime($career->created_at));  
                                         ?></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="pagination mt-30">
                        @if ($blogs_career->lastPage() >1)
                        <ul class="list-inline">
                            <li class="{{$blogs_career->currentPage() == 1 ? 'disabled' : ''}}"><a class="" href="{{$blogs_career->url(1)}}"><i class="arrow_carrot-2left"></i></a>
                                @for($i=1; $i<=$blogs_career->lastPage();$i++)
                                <li class="siam {{$blogs_career->currentPage() == $i ? 'current' : ''}}">
                                  <a class='page-numbers' href='{{$blogs_career->url($i)}}'>{{$i}}</a></li>
                                @endfor
                                <li class="{{$blogs_career->currentPage() == $blogs_career->lastPage() ? 'disabled' : '' }}"><a class="disabled" href="{{$blogs_career->url($blogs_career->currentPage() +1 )}}"><i class="arrow_carrot-2right"></i></a></li>
