            ...
            @foreach ($users_blogs as $blog)
                <tr>
                    ...
                    <td>
                        <div class="row">
                          <div>
                            <a  href="{{route('admin.users_blogs.edit' , $blog->id)}}" style="color: white;" class="btn btn-primary m-2"> Edit </a>
                          </div>
                          <div >
                            <form action="{{route('admin.users_blogs.destroy', $blog->id)}}" method="POST">
                              @csrf
                              @method('Delete')
