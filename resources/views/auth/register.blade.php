                       ...
                       @enderror
                            ...
                            <div class="form-group row">
                                <div class="col-12 form-group mb-25">
                                    ...
                                    <input style="font-size: 18px; font-weight:bold;" id="password-field" autocomplete="off" id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="Enter your password again" >
                                </div>
                            </div>    
